...
- **Projects** — working files for each effort. Drafts live here.
...
- **Deliverables** — finished work lands here. If it's not in Deliverables,
  it's not done.
- **Decisions** — a running record of what was decided and why, so you never
