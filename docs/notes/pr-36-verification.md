...
repair covering the four reproduced issues above. The local full suite reached
819 passed and 38 skipped; subsequent focused check/render coverage passed all 68
...
Final dependency integration, a stable-source full-suite rerun and actual Windows
CI remain required before merge. PR-35's platform repair and the separately
reproduced Library lock release race are tracked in their own focused changes.
